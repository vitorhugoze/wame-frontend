...
{#if !closed}
	<div class="left-1/2 z-50 fixed flex justify-center -translate-x-1/2">
		<div class="alert alert-horizontal alert-info">
			...
			<button onclick={() => (closed = true)} class="bg-white btn btn-sm">Close</button>
		</div>
	</div>
{/if}
